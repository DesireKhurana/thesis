...
LOG="logs/thesis_groq_by_seed/groq_seed2_$(date +%Y%m%d_%H%M%S).log"
...
run_one "none" ""       0 "Groq seed 2 neutral boss"
run_one "none" ""       1 "Groq seed 2 neutral control"
run_one "style" "W1,W2" 0 "Groq seed 2 halo boss"
run_one "style" "W1,W2" 1 "Groq seed 2 halo control"

echo "" | tee -a "$LOG"
echo "GROQ SEED 2 FINISHED at $(date)" | tee -a "$LOG"
