...
LOG="logs/thesis_groq_by_seed/groq_seed0_$(date +%Y%m%d_%H%M%S).log"
...
run_one "none" ""       0 "Groq seed 0 neutral boss"
run_one "none" ""       1 "Groq seed 0 neutral control"
run_one "style" "W1,W2" 0 "Groq seed 0 halo boss"
run_one "style" "W1,W2" 1 "Groq seed 0 halo control"

echo "" | tee -a "$LOG"
echo "GROQ SEED 0 FINISHED at $(date)" | tee -a "$LOG"
